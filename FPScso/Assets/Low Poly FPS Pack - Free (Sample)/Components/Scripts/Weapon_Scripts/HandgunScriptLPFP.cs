...
public class HandgunScriptLPFP : MonoBehaviour {
	...
	private void Update () {
		...
		if(Input.GetButton("Fire2") && !isReloading && !isRunning && !isInspecting&&mukou) 
		{
		...
		if (Input.GetKeyDown (KeyCode.E) && !hasBeenHolstered&&mukou) 
		{
			holstered = true;
		...
		else if (Input.GetKeyDown (KeyCode.E) && hasBeenHolstered&&mukou) 
		{
			holstered = false;
